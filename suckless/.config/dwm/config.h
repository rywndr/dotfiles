...
static const char *fonts[]          = { "Fira Code Nerd Font:size=11", "Noto Color Emoji:size=11" };
static const char dmenufont[]       = "Fira Code Nerd Font:size=11";

static const char col_bg0[]         = "#242424"; // background color
static const char col_bg1[]         = "#282828"; 
static const char col_fg[]          = "#242424"; // text color
static const char col_fg4[]         = "#bdae93"; 
static const char col_accent[]      = "#ebdbb2"; // workspace and title
static const char col_accent2[]     = "#d5c4a1"; 
